...
$uid = $_REQUEST['u_id'];
$query = "SELECT user.u_id,user.first_name,user.last_name,user.email,user.password,user.address,user.mobile_no,country.country_name,state.state_name,city.city_name,role.role_name,user.status FROM user LEFT JOIN country ON user.country=country.country_id LEFT JOIN state ON user.state=state.state_id LEFT JOIN city ON user.city=city.city_id LEFT JOIN role ON user.role=role.role_id where u_id='$uid'";
...
$query1 = "SELECT country.country_id,state.state_id,city.city_id,role.role_id FROM user LEFT JOIN country ON user.country=country.country_id LEFT JOIN state ON user.state=state.state_id LEFT JOIN city ON user.city=city.city_id LEFT JOIN role ON user.role=role.role_id  where u_id='$uid'";
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-10">
                            ...
                            <div class="box box-info">
                                ...
                                <!-- /.box-header -->
                                <!-- form start -->
                                <form class="form-horizontal" action="user_update.php" name="user" id="user" method="POST" onclick="return validateForm();">
                                    <div class="box-body">
                                        <div class="form-group">
                                            <input type="hidden" name="u_id" class="form-control" id="u_id" value="<?php echo $row['u_id']; ?>">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-4">
                                                <textarea  row="5" name="address" class="form-control" id="address" ><?php echo $row['address']; ?></textarea>
                                            </div>
                                            <div class="col-sm-4">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="radio" name="status">
                                                    <label for="status" class="col-sm-2 control-label">
                                                        <input type="radio" name="status" id="active" value="active" <?php if (!empty($status) && $status == 'active') echo 'checked = "$status"'; ?>>
                                                        Active
                                                    </label>
                                                    <label for="status"class="col-sm-2 control-label">
                                                        <input type="radio" name="status" id="inactive" value="inactive" <?php if (!empty($status) && $status == 'inactive') echo 'checked = "$status"'; ?>>
                                                        Inactive
                                                    </label>  
                                                </div>
                                                <div class="col-sm-4">

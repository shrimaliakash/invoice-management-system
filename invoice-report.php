                        ...
                        <div class="col-xs-12">
                            ...
                            <div class="box">
                                <div class="box-header">
                                    <h3 class="box-title">Month Wise Invoice Reports With Details</h3>
                                    
                                    
                                </div>
                                <div class="col-sm-12">
                                    <a href="invoice_report_print.php" class="btn btn-default"><i class="fa fa-print"></i>Print</a>
                                </div>
                                <!-- /.box-header -->
                                <div class="box-body table-responsive">
                                    <table id="example1" class="table table-bordered table-striped">
                                        ...
                                        <tbody>
                                                <?php
                                                    $sql = "SELECT COUNT(DISTINCT(invoice.invoice_id)) AS total_invoice,MONTHNAME(invoice.date) AS date,
                                                            ...
                                                            invoice_details.product_code=product.product_code GROUP BY MONTH(invoice.date) 
                                                            ORDER BY MONTHNAME(invoice.date)";

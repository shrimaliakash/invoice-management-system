...
<html>
    ...
    <body>  
        ...
        <div class="container content">
            ...
            <form class="form-horizontal quotation-form" action="quotation1.php" id="quotation-form" method="post" role="form" onclick="calculateTotal1();
                    calculateTotal();
                    calculateTotal2();">
                ...
                <div class="row no-margin">
                    ...
                    <div class='col-xs-12 col-sm-offset-3 col-md-offset-3 col-lg-offset-3 col-sm-4 col-md-4 col-lg-4'>
                        <h4>&nbsp;</h4>
                        <div class="form-group">
                            <input type="text" class="form-control autocomplete_txt1" name="quotation_id" id="quotation_id" placeholder="quotation Id" value="<?php echo $quotation_id; ?>">
                        </div>
                        <div class="form-group">
                            <input type="text" class="form-control autocomplete_txt1" name="quotationDate" id="quotationDate" placeholder="quotation Date" value="<?php echo date('m/d/Y' , strtotime($date)) ; ?>">
                        </div>
                        <div class="form-group">
                    ...
                    <div class='col-xs-offset-2 col-xs-9 col-sm-offset-2 col-md-offset-3 col-lg-offset-3 col-sm-4 col-md-3 col-lg-3'>
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" class="form-control" name="quotation_subtotal" id="subTotal" placeholder="Subtotal" ondrop="return false;" onpaste="return false;" value="<?php echo $gross_amount; ?>">
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                <div class="input-group-addon">Rs.</div>
                                <input type="text" class="form-control" name="taxAmount" id="taxAmount" placeholder="Tax" ondrop="return false;" onpaste="return false;">	
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                <div class="input-group-addon">Rs.</div>
                                <input type="text" class="form-control" name="quotation_total" id="totalAftertax" placeholder="Total" ondrop="return false;" onpaste="return false;" value="<?php echo $total_amount; ?>">
                            </div>
                        </div>

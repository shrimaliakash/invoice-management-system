...
$query = "select * from taxation where taxation_id='$tid'";
$result = mysqli_query($conn, $query);
$row = mysqli_fetch_array($result);

$taxation_id = $row['taxation_id'];
$tax = $row['tax'];
                    ...
                    <div class="row">
                        <div class="col-md-10">
                            ...
                            <div class="box box-info">
                                ...
                                <!-- /.box-header -->
                                <!-- form start -->
                                <form class="form-horizontal" action="taxation_update.php" name="user_add" id="user_add"  method="POST" onclick="return validateForm();">
                                    <div class="box-body">
                                        <div class="form-group">
                                            <input type="hidden" name="taxation_id" class="form-control" id="taxation_id" value="<?php echo $taxation_id; ?>">
                                            <label for="tax" class="col-sm-4 control-label">Tax</label>
                                            <div class="col-sm-4">
                                                <input type="text" name="tax" class="form-control" id="tax" placeholder="Enter Tax" value="<?php echo $tax; ?>">
                                            </div>
                                            <div class="col-sm-4">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-4">
                                                <select class="form-control" name="tax_name" id="tax_name">
                                                    <option value="<?php echo $taxation_id; ?>"><?php echo $tax_name; ?></option>
                                                    <?php
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-4">
                                                <input type="text" name="tax_percentage" class="form-control" id="tax_percentage" placeholder="Enter Percentage" value="<?php echo $tax_percentage; ?>">
                                            </div>
                                            <div class="col-sm-4">
                                                <span class ="error" name="tax_percentage_error" id="tax_percentage_error">*</span>
                                            </div>
                                        </div>
                                        <button type="submit" name="submit" id="submit" class="btn btn-info pull-right">ADD</button>
                                    </div>
                                </form>
                            </div>
                        </div>

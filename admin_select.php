                                            ...
                                            <tr>
                                                ...
                                                if (mysqli_num_rows($result) > 0) {
                                                    while ($row = mysqli_fetch_assoc($result)) {
                                                        ...
                                                        echo "<td>" . "<img  style='height:50px;width:50px;' src='uploads/{$row['admin_image']}'>" . "</td>";
                                                        echo "<td>"."<a href='admin_delete.php?admin_id=".$row["admin_id"]."' class='btn btn-danger'>Delete</a>"."</td></tr>";
                                                    }
                                                }
                                                ?>
                                            </tr>

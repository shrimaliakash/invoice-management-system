    ...
    <div class="row">
        ...
        <div class="col-md-6">
            ...
            <div class="box box-primary">
                ...
                <!-- /.box-header -->
                <!-- form start -->
                <form role="form" name="form" method="POST" action="insert.php">
                    <div class="box-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="mno" class="form-control" id="number" placeholder="Enter Number">
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <div class="checkbox" name="hobby[]">
                                <label class="checkbox-inline">
                                    <input type="checkbox" name="hobby[]" value="Cricket">
                                    Cricket
                                </label>
                                <label>
                                    <input type="checkbox" name="hobby[]" value="Vollyball">
                                    Vollyball
                                </label>
                                <label>
        ...
        <div class="col-md-6">
            ...
            <!-- /.box -->
            <!-- User Registration elements disabled -->

...
<?php
$query2 = mysqli_query($conn, "SELECT * FROM invoice");
            ...
            <form class="form-horizontal invoice-form" action="<?php echo $_SERVER['PHP_SELF']; ?>" id="invoice-form" method="post" role="form" novalidate>
                ...
                <div class="row no-margin">
                    ...
                    <div class='col-xs-12 col-sm-offset-3 col-md-offset-3 col-lg-offset-3 col-sm-4 col-md-4 col-lg-4'>
                        ...
                        <div class="form-group">
                            <input type="text" class="form-control autocomplete_txt1" name="invoice_id" id="invoice_id" placeholder="Invoice Id" value="<?php echo $rowCount3; ?>">
                        </div>
                        <div class="form-group">
                            <input type="text" class="form-control autocomplete_txt1" name="invoiceDate" id="invoiceDate" placeholder="Invoice Date" value="<?php date_default_timezone_set("Asia/Calcutta");
                            echo date("d/m/Y");
                            ?>">
                        </div>
                        <div class="form-group">
                    ...
                    <div class='col-xs-offset-2 col-xs-9 col-sm-offset-2 col-md-offset-3 col-lg-offset-3 col-sm-4 col-md-3 col-lg-3'>
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                ...
                                <input type="number" class="form-control" name="invoice_subtotal" id="subTotal" placeholder="Subtotal" ondrop="return false;" onpaste="return false;">
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                <div class="input-group-addon">Rs.</div>
                                <input type="number" class="form-control" name="invoice_total" id="totalAftertax" placeholder="Total" ondrop="return false;" onpaste="return false;">
                            </div>
                        </div>							
